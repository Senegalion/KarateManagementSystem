...
@Component({
  selector: 'app-user-signed-up-sessions',
  standalone: true,
  imports: [
    NgForOf,
    NgIf,
  ...
  templateUrl: './user-signed-up-sessions.component.html',
  styleUrl: './user-signed-up-sessions.component.css'
})
export class UserSignedUpSessionsComponent implements OnInit {
  ...
  viewFeedback(session: TrainingSession) {
    this.trainingSessionService.getFeedback(session.id!).subscribe(feedbacks => {
